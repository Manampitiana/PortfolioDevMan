...
export default function Cv() {
  ...
  return (
    <>
      <Helmet>
        <title>
          CV | {settings?.site_name || "ManDev"} - Full Stack Web Developer
        </title>

        <meta
          name="description"
          content="View or download the professional CV of ManDev, a Full Stack Web Developer from Madagascar."
        />
