        ...
        {existingGallery.length > 0 && (
          <div className="flex gap-2 mt-2 flex-wrap">
            {existingGallery.map((file, idx) => (
              <img key={idx} src={file} alt={`Gallery ${idx}`} className="h-16 w-16 object-cover rounded" />
            ))}
          </div>
        )}
        {/* New gallery */}
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          {form.cover_image ? (
            ...
            <img src={existingCover} alt="Existing Cover" className="h-16 w-16 object-cover rounded" />
          ) : null}
        </div>
      </div>
