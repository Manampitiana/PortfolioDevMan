...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-neutral-950 border-t border-white/5 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-16 pb-8">
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          <div className="md:col-span-5">
            <div className="flex items-center mb-6">
              <Link to="/" className="flex items-center group">
                <div className="w-9 h-9 overflow-hidden  rounded-full flex items-center justify-center mr-3 shadow-lg shadow-cyan-500/20 group-hover:rotate-6 transition-transform">
                  {settings?.logo ? (
