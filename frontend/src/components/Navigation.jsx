      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center group">
            <div className="w-9 h-9 overflow-hidden rounded-full flex items-center justify-center mr-3 shadow-lg shadow-cyan-400/20 group-hover:rotate-6 transition-transform">
              {settings?.logo ? (
